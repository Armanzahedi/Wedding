...
namespace Wedding.Web.Areas.Apanel.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(IUserRepository userRepo, RoleManager<IdentityRole> roleManager, UserManager<User> userManager, MyDbContext context)
        {
            _userRepo = userRepo;
        ...
        {
            var usersGrid = _context.Users.Where(u=>u.IsEmployee).Select(item =>
        ...
        [HttpPost]
        public async Task<IActionResult> Create(AddUserViewModel form)
        {
